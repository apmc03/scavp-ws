...
class FuncionarioController extends Controller
{
    protected $reglasValidacion = [
        ...
        'ci' => 'required|string|max:10|unique:funcionarios',
        'correo' => 'required|string|email|max:50|unique:funcionarios',
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            $data = Funcionario::find($request->funcionario_id);
            $data->fill($request->all());
            $data->update();
